...
`}
      <Reverso ch='小' />
      {`
Дополнительно смотрите переводы с примерами на английском языке от Reverso Context. Иногда одного 大БКРС не хватает и нужно знать перевод не только на русский, но и на английский: кому-то это нужно по работе, кому-так так проще запоминать, другим же просто может стать интересно. Я сам постоянно держу Reverso Context открытым, когда работаю с китайским, потому что английский помогает мне запоминать переводы и понимать, как использовать слова и выражения в речи.
