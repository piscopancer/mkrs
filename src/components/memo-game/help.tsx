...
export default function Help({ ...attr }: Dialog.DialogTriggerProps) {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger {...attr} className={clsx(attr.className, 'rounded-md bg-zinc-800 px-6 py-1.5 text-lg text-zinc-200 duration-100 hover:bg-zinc-700 @max-md/settings:px-4')}>
